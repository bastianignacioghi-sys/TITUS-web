          ...
          <div className="flex flex-col justify-center gap-6 pt-36 pb-16">
            ...
            >
              <a
                ...
                style={{ background: '#25D366', borderRadius: 4, padding: '16px 32px', fontSize: 14, letterSpacing: '0.06em', fontFamily: 'Inter, sans-serif', textDecoration: 'none', transition: 'background 0.2s' }}
